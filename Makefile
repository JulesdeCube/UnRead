...
SRC=main.c load_Image/load.c load_Image/change_color.c load_Image/tools.c load_Image/segmentation.c load_Image/rotate.c load_Image/resize.c load_Image/auto_rotation.c
DEPS=load_Image/load.h load_Image/change_color.c load_Image/tools.h load_Image/segmentation.h load_Image/rotate.h load_Image/resize.h load_Image/auto_rotation.h
BUILD=UnRead-0.1.0
